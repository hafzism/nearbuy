...
class _dboyregState extends State<dboyreg> {
  ...
  Future<void> submitForm() async {
    ...
    final Uri uri = Uri.parse('$url/dboy_register/');
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (status == 'ok') {
          ...
          Fluttertoast.showToast(msg: 'Email or phone already exist');
                                ...
                                child: Column(
                                  children: [
                                    Image(image: NetworkImage(
                                      ...
                                      height: 200,
                                      width: 200,),
                                    Text('Profile Pic', style: TextStyle(color: Colors.cyan))
                                  ],
                                ),
                              ),
                            },
                                ...
                                child: Column(
                                  children: [
                                    Image(image: NetworkImage(
                                      ...
                                      height: 200,
                                      width: 200,),
                                    Text('Id proof', style: TextStyle(color: Colors.cyan))
                                  ],
                                ),
                              ),
                            },
